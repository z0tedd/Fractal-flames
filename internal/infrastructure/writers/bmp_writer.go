...
func NewBmpWriter(canvas application.Canvas, config *domain.Config) *BmpWriter {
	return &BmpWriter{canvas: canvas.Canvas(), config: config}
}

func (w BmpWriter) Write() error {
